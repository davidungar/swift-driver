...
extension Option {
  ...
  public static let experimentalDynamicBatching: Option = Option("-experimental-dynamic-batching", .separate, attributes: [.noInteractive, .doesNotAffectIncrementalBuild], helpText: "Dynamically assign primary files to batch compiles")
...
extension Option {
  public static var allOptions: [Option] {
    return [
      ...
      Option.experimentalDynamicBatching,
